...
def main():
    ...
    while choice.lower() != "stop":
        ...
        print("3. Most Common Combinations")
        print("0. Exit")
...
def show_PopularCombos():
    ...
    # axs.ylabel('Counts') 
    # axs.title('Counts of Categories') 
    # axs.xticks(rotation=45, ha='right') 
    # Rotate x-ticks for better readability plt.tight_layout() 
    # Adjust layout to prevent clipping of tick-labels 
    # Annotate the bars with the counts 
    # for i, count in enumerate(comboDfy): 
    #     axs.text(i, count + 2, str(count), ha='center', va='bottom')
    plt.show()
