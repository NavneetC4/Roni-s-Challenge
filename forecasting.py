...
dark_theme_layout = {
    "plot_bgcolor": "#1c1c1c",  # Dark background for plots
...
fig2.update_layout(
    dark_theme_layout,
    title='Seasonal Trends of Top 5 Toppings',
    xaxis_title='Month',
...
fig4 = px.bar(
    ...
    color_discrete_sequence=['#87CEEB']  # Light Sky Blue color for lighter bars
)
